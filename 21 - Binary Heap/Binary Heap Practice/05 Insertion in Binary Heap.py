...
def heapify_tree_insert(root_node, index, heap_type):
    ...
    if index <= 1:
        ...
        if root_node.binary_heap[index] < root_node.binary_heap[parent]:
            root_node.binary_heap[index], root_node.binary_heap[parent] = root_node.binary_heap[parent], root_node.binary_heap[index]
            heapify_tree_insert(root_node, parent, heap_type)
    elif heap_type == "Min":
        if root_node.binary_heap[index] > root_node.binary_heap[parent]:
            root_node.binary_heap[index], root_node.binary_heap[parent] = root_node.binary_heap[parent], root_node.binary_heap[index]
            heapify_tree_insert(root_node, parent, heap_type)
