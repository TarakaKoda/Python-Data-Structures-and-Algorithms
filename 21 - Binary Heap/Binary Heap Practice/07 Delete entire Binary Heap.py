...
def preOrder_traversal(root_node, index=1):
...
def inOrder_traversal(root_node, index=1):
    if not root_node.binary_heap:
        return print("Binary Heap does not exist")
    if index <= root_node.heap_size:
...
def postOrder_traversal(root_node, index=1):
    if not root_node.binary_heap:
        return print("Binary Heap does not exist")
    if index <= root_node.heap_size:
...
def delete_entire_binary_heap(root_node):
    root_node.binary_heap = None
    return "Binary Heap has been Deleted"
...
if __name__ == "__main__":
    ...
    insert(new_binary_heap, 8, "Min")
    insert(new_binary_heap, 9, "Min")
    preOrder_traversal(new_binary_heap)
    print(delete_entire_binary_heap(new_binary_heap))
    inOrder_traversal(new_binary_heap)
