class Linked_List:
    ...
    - Inserting into a Circular Single Linked List is same as the Singly Linked List but we need to change the last node
      reference to the first node/newly inserted node.
    - We can insert into Circular Singly Linked List in 3 ways:
