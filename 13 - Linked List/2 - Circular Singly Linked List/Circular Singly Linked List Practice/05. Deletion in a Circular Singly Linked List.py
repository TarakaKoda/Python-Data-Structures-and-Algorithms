...
class Circular_Singly_Linked_List:
    ...
    def deletion_entire_circular_singly_linked_list(self):
        if self.head is None:
            print(f"Circular Singly Linked List does not exist")
        else:
            self.head = None
            self.tail = None
...
if __name__ == "__main__":
    ...
    print([node.value for node in circular_singly_linked_list])
    circular_singly_linked_list.deletion_entire_circular_singly_linked_list()
    circular_singly_linked_list.deletion_entire_circular_singly_linked_list()